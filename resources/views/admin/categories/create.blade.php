        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Add New Category</div>
                    <div class="tools">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="namear" required value="{{old('namear')}}" id="namear" class="form-control input-circle-right" placeholder="Arabic Name"></div>
                                            </div>
                                            <div class="form-group">
                                                <label>Status:</label>
