                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="name" required value="{{$category->name}}" id="name" class="form-control input-circle-right" placeholder="Name"></div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="namear" required value="{{$category->namear}}" id="namear" class="form-control input-circle-right" placeholder="Arabic Name"></div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                            <img src="{{asset('images/category/'.$category->image)}}"  alt="" /> </div>
