        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Edit Sub-Category</div>
                    <div class="tools">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="name" required value="{{$subcategory->name}}" id="name" class="form-control input-circle-right" placeholder="Name"></div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="name_ar" required value="{{$subcategory->namear}}" id="name_ar" class="form-control input-circle-right" placeholder="Arabic Name"></div>
                                            </div>
