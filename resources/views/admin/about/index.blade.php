...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            {!! Form::open(['route' => ['about.store'] , 'method' => 'post','class'=>'form-horizontal form-row-seperated','files'=>true  ]) !!}
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-plus-circle"></i>About Us Site Data </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane " id="tab_l">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Header 1 Arabic:
                                            <span class="required"> * </span>
                                        </label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" required value="{{$data->h1_ar}}" name="h1_ar" placeholder="1st Section Arabic Header"> </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="tab_2">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Header 2 Arabic
                                            <span class="required"> * </span>
                                        </label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" required value="{{$data->h2_ar}}" name="h2_ar" placeholder="2nd Section Arabic Header"> </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="tab_3">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Header 3 Arabic:
                                            <span class="required"> * </span>
                                        </label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" required value="{{$data->h3_ar}}" name="h3_ar" placeholder="3rd Section Arabic Header"> </div>
                                    </div>
