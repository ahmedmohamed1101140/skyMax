                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="name" required value="{{old('name')}}" id="name" class="form-control input-circle-right" placeholder="Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="name_ar" required value="{{old('name_ar')}}" id="name_ar" class="form-control input-circle-right" placeholder="Arabic Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="location" required value="{{old('location')}}" id="name" class="form-control input-circle-right" placeholder="Location">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="location_ar" required value="{{old('location_ar')}}" id="location_ar" class="form-control input-circle-right" placeholder="Arabic Location">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="form-control maxlength-handler" rows="8"  required name="description" maxlength="255"></textarea>
                                                    <br><br><br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="form-control maxlength-handler" rows="8"  required name="description_ar" maxlength="255"></textarea>
                                                    <br><br><br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="required"> * </span>
                                                <div class="input-group">
                                                    <input class="form-control form-control-inline input-medium date-picker" required name="date" size="16" type="text" value="{{old('date')}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="mm/dd/yyyy">
                                                    ...
                                                    <input type="text" value="{{old('from')}}" required class="form-control" name="from">
                                                    <span class="input-group-addon"> to </span>
                                                    <input type="text" class="form-control" value="{{old('to')}}" required name="to"> </div>
                                            </div>
