    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{$pin_credits->count()}}">0</span> </div>
                    <div class="desc"> Total E-Pin Credits </div>
                </div>
            </a>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <input type="hidden" name="pin_credit" value="0">
            <div class="row">
                <div class="col-md-4">
