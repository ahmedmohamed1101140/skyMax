        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Edit City</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            {{Form::open(['route' => ['cities.update',$city->id] , 'method' => 'put','files'=>true]) }}
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="name" required value="{{$city->name_eng}}" id="name" class="form-control input-circle-right" placeholder="Name"></div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="namear" required value="{{$city->name}}" id="namear" class="form-control input-circle-right" placeholder="Arabic Name"></div>
                                            </div>
