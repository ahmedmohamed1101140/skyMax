        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Add New Slider</div>
                    <div class="tools">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-icon right">
                                                    <textarea class="form-control maxlength-handler" rows="8"  required name="details" maxlength="255">{{old('details')}}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-icon right">
                                                    <textarea class="form-control maxlength-handler" rows="8"  required name="details_ar" maxlength="255">{{old('details_ar')}}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-icon right">
                                                    <textarea class="form-control maxlength-handler" rows="8"  required name="description" maxlength="255">{{old('description')}}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-icon right">
                                                    <textarea class="form-control maxlength-handler" rows="8"  required name="description_ar" maxlength="255">{{old('description_ar')}}</textarea>
                                                </div>
                                            </div>
