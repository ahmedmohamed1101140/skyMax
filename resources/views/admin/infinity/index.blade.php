...
@section('content')
    ...
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title"> Infinity
    </h1>
    <!-- END PAGE TITLE-->
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            {!! Form::open(['route' => ['infinity.store'] , 'method' => 'post','class'=>'form-horizontal form-row-seperated','files'=>true  ]) !!}
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-plus-circle"></i>Infinity Data </div>
