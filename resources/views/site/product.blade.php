                            ...
                            <div class="col-md-7 col-xs-12 details">
                                ...
                                <div class="prc1 col-md-7 no-pd col-xs-12">
                                    @if($product->discount)
                                        ...
                                        <div class="col-md-6 col-sm-6 no-pd col-xs-12 ">
                                            <h3 class="prch2">Offer. <span class="prcno1">{{$product->discount}}
                                                    EGP</span></h3>
                                        </div>
                                    @else
                                        <div class="col-md-6 col-sm-6 no-pd col-xs-12 ">
                                ...
                                @if($product->type == 1)
                                    <div class="col-md-6 col-xs-12 modq no-pd">
                                        <h4>Shipping Fees: <span>{{$product->shipping_phease}} EGP </span></h4>
                                    </div>
                                @endif
                                <div class="col-md-6 col-xs-12 modq no-pd ">
                ...
                <div class="wrapper">
                    ...
                    <section id="first-tab-group2" class="tabgroup2">
                        ...
                        @auth
                            ...
                            <div class="form-group nw-pd">
                                OR
                               Address<input name="address_input" type="text" class="form-control"
                                       placeholder="address">
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group nw-pd">
                                Name<input required name="name" type="text" class="form-control"
                                           placeholder="Name" value="{{auth()->user()->fname}} {{auth()->user()->sname}} {{auth()->user()->lname}}">
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group nw-pd">
                            ...
                            <div class="clearfix"></div>
                            <div class="form-group nw-pd">
                                Email<input required name="email" type="text" class="form-control"
                                       placeholder="E-mail" value="{{auth()->user()->mail}}">
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group nw-pd">
                                Phone<input required name="mobile" type="number" class="form-control"
                                       placeholder="mobile" value="{{auth()->user()->phone}}">
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group nw-pd">
                                Amount<input required name="amount" type="number" class="form-control"
                                            placeholder="mobile"  value="1" min="1" max="{{$product->amount}}">
                            </div>
                            <div class="clearfix"></div>
