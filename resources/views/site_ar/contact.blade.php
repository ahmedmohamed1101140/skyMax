...
@section('title')SkyMax | اتصل بنـا@endsection
@section('content')
                ...
                <div class="row margin-top-large">
                 <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="col-md-5 margin-top">
                        <h3 class="section-title">اتصـل بنا <span></span></h3>
                        <p class="myp">{{$item->p2_ar}}</p>
                        <h4>Contact Us:</h4>
                      ...
                      <div class="logregform">
                        <div class="feildcont">
            				...
            				<form action="{{url("contact")}}" method="post" role="form" class="clearfix">
                                ...
                                <div >
                                <label>البريد الاليكتروني <em>*</em></label>
                                <div class="form-group clearfix">
                                ...
                                <button type="submit" class="fbut">ارسل</button>
