...
@section('title')SkyMax | المحادثات @endsection
@section('content')
    ...
    <div id="page-inside6" class="insd">
        ...
        <div class="container">
            <div class="event-title">
                <h1>مجتمع سكاي ماكس</h1>
                <p>إذا كان هناك موقع معين في موقعك على الويب يمكنك من خلاله الفوز بالأشخاص ، فستكون صفحة "من نحن". فيما يلي كيفية جعلها تبدو جيدة.
                </p>
            </div>
                ...
                <div class="chat-box clearfix">
                    ...
                    <div class="enter-message">
                        <form method="post" action="{{url("send_message")}}">
                            ...
                            <input type="text" id="message" name="message" required class="msg" placeholder="أكتــب رسـالـك .."/>
                            {{--<a href="#" class="btn btn-org pull-right nw-pad ">Send</a>--}}
                            <button type="submit" style="margin-left: 15px;" class="btn btn-org pull-right nw-pad ">أرســل</button>
