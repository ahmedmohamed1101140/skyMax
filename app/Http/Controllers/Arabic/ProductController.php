...
class ProductController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if($product->video_id == 1){
            ...
            return view('site_ar.product_video',compact('countries','categories','states','product'));
        }
        else{
            return view('site_ar.product', compact('countries', 'states','product','images', 'categories', 'sub_categories'));
        }
...
//    }
    ...
    public function products(Request $request)
    {
        ...
        return view('site_ar.index', compact('countries', 'products', 'categories', 'sub_categories' , 'states'));
    }
    ...
    public function types(Request $request)
    {
        ...
        session()->put('product_type_id', $request->get('product_type_id'));
        return view('site_ar.index', compact('countries', 'products', 'categories', 'sub_categories'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('site_ar.index', compact('countries','states', 'products', 'categories', 'sub_categories'));
...
//        return view('site.index', compact('countries','states', 'products', 'categories', 'sub_categories'));
    ...
    public function my_products(Request $request){
        ...
        $countries = Country::all();
        $states = State::all();
        return view('site_ar.myorders', compact('orders','countries','states'));
    }
