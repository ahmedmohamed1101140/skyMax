...
//    }
    ...
    public function index()
    {
        ...
        $sliders = Slider::all();
        return view('site.index', compact('countries','states','sub_categories' , 'products', 'categories' , 'sliders'));
    }
    ...
    public function about()
    {
        ...
        return view('site.about', compact('countries','states',  'item'));
    }
    ...
    public function infinity()
    {
        ...
        return view('site.infinity', compact('countries','states', 'item'));
    }
    ...
    public function founders()
    {
        ...
        $items = Founder::all();
        $item = About::find(2);
        return view('site.founders', compact('countries', 'states','items','item'));
    }
    ...
    public function events()
    {
        ...
        return view('site.events', compact('countries','states'))->with('events',$events_array);
    }
    ...
    public function processes()
    {
        ...
        $states = State::all();
        $item = About::find(3);
        return view('site.processes', compact('countries','states', 'item'));
    }
    ...
    public function contact()
    {
        ...
        return view('site.contact', compact('countries','states','item'));
    }
...
//        dd($request->all());
        ...
        if($event_check->count() > 0){
            session()->flash('error','your registration for this event is submitted Before');
            return redirect()->back();
        }
        ...
        session()->flash('message','congratulation your request submitted we contact with you soon');
        return redirect()->back();
    }
