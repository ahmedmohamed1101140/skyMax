...
class InfinityController extends Controller
{
    ...
    public function index()
    {
        //
        $data = About::find(2);
        return view('admin.infinity.index',compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->h1 = $request->h1_ar;
        $data->p1 = $request->p1_ar;
        $data->h2 = $request->h2_ar;
        $data->p2 = $request->p2_ar;
        $data->h3 = $request->h3_ar;
        $data->p3 = $request->p3_ar;
        ...
        $data->save();
        session()->flash('message','Infinity updated successfully');
